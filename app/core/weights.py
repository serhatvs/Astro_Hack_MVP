...
from app.models.mission import ConstraintLevel, Duration, Goal, MissionProfile
...
def derive_system_weights(mission: MissionProfile) -> dict[str, float]:
    """Adjust system scoring emphasis from mission constraints."""
