  ...
  return (
    <div className="min-w-0 overflow-hidden rounded-xl">
      <motion.div
        ...
        className="gradient-border-card relative flex h-full w-full min-h-[260px] min-w-0 flex-col gap-2 overflow-hidden p-4 transition-shadow cursor-default hover:neon-glow-cyan"
      >
        ...
        <div className="min-w-0 flex-1 space-y-0.5 overflow-auto pr-1 text-xs">
