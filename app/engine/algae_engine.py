...
class AlgaeEngine:
    ...
    def _mission_fit(
        ...
        environment_fit = 1.0 if mission.environment in system.preferred_environments else 0.62
    ...
    def _risk_score(
        ...
        mismatch_penalty = 0.0 if mission.environment in system.preferred_environments else 0.16
        return max(
            0.0,
            min(
                1.0,
